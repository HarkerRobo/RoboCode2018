 ...
 */
public class LocalMotionBuilder {
	 ...
	 */
	public LocalMotionBuilder(int period, Subsystem... required) {
		this.period = period;
	 ...
	 * @return the builder
	 */
	public LocalMotionBuilder group(Path trajectory, int profileSlot, double distancePerRotation,
	 ...
	 * @return the builder
	 */
	public LocalMotionBuilder group(Path trajectory, int profileSlot, double f, double p, double i, double d,
	 ...
	 */
	public LocalMotionCommand build() {
		return new LocalMotionCommand(period, groups.toArray(new Group[0]), required);
	}
	...
	public static class Group {
		 ...
		 *            the talons to run this trajectory on
		 */
		public Group(Path trajectory, int profileSlot, double f, double p, double i, double d, int integralZone,
